...
class UserPropSet(PropSet):
    ...
    def __init__(self, user_json):
        self.set_user(
            ...
            user_json["credentialSubject"]["organization"]["name"],
            user_json["credentialSubject"]["organization"]["type"],
        )
...
class TransProps:
    ...
    recv_constraints: ReceiverConstraints
